      ...
      <div className="flex flex-wrap items-center gap-3 px-5 py-3 bg-muted border-b border-border">
        ...
        {mode === 'archive' && (
          <button
            ...
            className="ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-800 hover:bg-red-700 text-white text-xs font-semibold transition-colors shadow-sm"
          >
            <svg
