...
import { LogOut, Send, Trash2, Edit3, XCircle, FileText, Users } from 'lucide-react';
...
const emptyEmployee = {
  name: '', designation: '', bioBn: '', bioEn: '', imageURL: '',
};
        ...
        <div className="lg:col-span-2">
          <div className="bg-card shadow-xl rounded-2xl border border-border overflow-hidden">
            ...
            <form onSubmit={(e) => handleSubmit(e)} className="p-8 space-y-6">
              ...
              <button type="submit" className={`w-full p-4 font-black rounded-xl text-white transition-all uppercase shadow-xl flex items-center justify-center gap-2 bg-brandBlack hover:bg-brandRed`}>
            ...
            {allNews.map((item) => (
              <div key={item._id} className="flex items-center gap-3 border-b border-border pb-3 group hover:bg-muted p-2 rounded-lg transition-all">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex gap-2">
                    {<span className="text-[8px] bg-muted text-muted-foreground px-1 rounded font-bold uppercase">News</span>}
              ...
              <form onSubmit={handleEmployeeSubmit} className="p-8 space-y-6">
                ...
                <div className="space-y-4">
                  <textarea
                    ...
                    onChange={(e) => setEmployee({ ...employee, bioBn: e.target.value })}
                    required
                  />
                  <textarea
                    ...
                    onChange={(e) => setEmployee({ ...employee, bioEn: e.target.value })}
                    required
                  />
                </div>
